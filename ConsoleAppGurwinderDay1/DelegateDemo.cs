...
//{
//    public delegate void MyDelegate(string param); // declaration Pointer To Function  
...
//        static void Main()
//        {
//            //MyDelegate del = new MyDelegate(Hello); // argument - Hello itself is function
//            //del("Hello World! Welcome in MyDelegate");

//            //MyDelegate myDelegate = new MyDelegate(MyMessage);
//            //myDelegate(".......................");
...
//            //TwoIntDelegate two = new TwoIntDelegate(Sum);
//            //int r = two(10, 20);
